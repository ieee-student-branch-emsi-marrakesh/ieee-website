...
export function buildApplicationEmail(data: ApplicationData): string {
  const safeName = escapeHtml(data.fullName);
  const safeEmail = escapeHtml(data.email);
  const safePhone = escapeHtml(data.phone);
  const safeWhyJoin = escapeHtml(data.whyJoin);
          ...
          <tr>
            <td style="background: linear-gradient(135deg, #00629B 0%, #004471 100%); padding:32px 40px; text-align:center;">
              ...
              <p style="margin:6px 0 0; color:rgba(255,255,255,0.75); font-size:13px; letter-spacing:1px; text-transform:uppercase;">
                EMSI Marrakesh — New Application
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:32px 40px;">
                ...
                <tr>
                  <td style="padding:24px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td style="padding:8px 0; border-bottom:1px solid #e8ecf1;">
                          <span style="color:#8892a4; font-size:11px; text-transform:uppercase; letter-spacing:1px; font-weight:600;">Phone</span><br/>
                          <span style="color:#1a1a2e; font-size:16px; font-weight:600;">${safePhone}</span>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding:8px 0;">
                          <span style="color:#8892a4; font-size:11px; text-transform:uppercase; letter-spacing:1px; font-weight:600;">Why They Want to Join</span><br/>
                          <span style="color:#1a1a2e; font-size:14px; line-height:1.6;">${safeWhyJoin}</span>
                        </td>
                      </tr>
                    </table>
                  </td>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-top:28px;">
                <tr>
                  <td align="center">
                    <a href="mailto:${safeEmail}?subject=Re: IEEE Membership Application" style="display:inline-block; padding:14px 32px; background-color:#00629B; color:#ffffff; border-radius:10px; text-decoration:none; font-weight:700; font-size:14px; letter-spacing:0.5px;">
                      Reply to Applicant →
                    </a>
                  </td>
                </tr>
          ...
          <tr>
            <td style="background-color:#f8f9fc; padding:20px 40px; text-align:center; border-top:1px solid #e8ecf1;">
              <p style="margin:0; color:#8892a4; font-size:12px;">
                Sent from <strong>IEEE S.B EMSI Marrakesh</strong> website recruitment form
              </p>
            </td>
          </tr>
